...
#define VECTOR_SIGN(name, type, func, ret, ...) ret vector##name##_##func(__VA_ARGS__)

#define VECTOR_SIGN_V(name, type, func, ret, ...)                                                  \
    VECTOR_SIGN(name, type, func, ret, Vector##name* vec __VA_OPT__(, ) __VA_ARGS__)
...
#define VECTOR_SIGN_APPEND_ARR(name, type)                                                         \
    VECTOR_SIGN_V(name, type, append_arr, size_t, type* arr, size_t len)
